class Animal{
    ...
    getInfo(){
        return `${this.eat()},${this.sleep()} and make ${this.makeSound()}}`;
    }
}
...
getInfo(){
    return `Dog's name is ${this.name},breed ${this.breed},age ${this.age}, make "${this.makeSound()}" sound`;
}
}
...
getInfo(){
    return `Cat's name is ${this.name},age ${this.age},color ${this.color},make "${this.makeSound()}" sound`
}
